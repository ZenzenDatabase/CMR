...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 29 14:04:10 2019
...
positive_input = Input((1024,))
print("positive input:", positive_input)
negative_input = Input((1024,))
print("negative input:", negative_input)
## Neural Networks
Anchor_DNN = create_network(128)
Shared_DNN = create_base_network(1024)
...
#model.fit_generator(myGenerator(config, train_audio, train_rgb, \
 #                               train_lab, 400), steps_per_epoch=400, nb_epoch=20)
